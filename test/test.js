...
var _user$project$Color_Blending$colorDodge$ = F2(
	function (cB, cS) {
...
var _user$project$Color_Blending$colorBurn$ = F2(
	function (cB, cS) {
...
var _user$project$Color_Blending$softlight$ = F2(
	function (cB, cS) {
...
var _user$project$Color_Blending$screen$ = F2(
	function (cB, cS) {
		return (cB + cS) - (cB * cS);
	});
var _user$project$Color_Blending$overlay$ = F2(
	function (cB, cS) {
		var cB$ = cB * 2;
		return (_elm_lang$core$Native_Utils.cmp(cB$, 1) < 1) ? (cB$ * cS) : A2(_user$project$Color_Blending$screen$, cB$ - 1, cS);
	});
var _user$project$Color_Blending$clampChannel = A2(_elm_lang$core$Basics$clamp, 0, 1);
var _user$project$Color_Blending$calcChanel = F6(
	function (fn, aB, aS, ar, cB, cS) {
		var cS$ = _elm_lang$core$Basics$toFloat(cS) / 255;
		var cB$ = _elm_lang$core$Basics$toFloat(cB) / 255;
		var cr = A2(fn, cB$, cS$);
		var cr$ = _elm_lang$core$Native_Utils.eq(ar, 0) ? cr : (((aS * cS$) + (aB * (cB$ - (aS * ((cB$ + cS$) - cr))))) / ar);
		return _elm_lang$core$Basics$round(
			_user$project$Color_Blending$clampChannel(cr$) * 255);
	});
var _user$project$Color_Blending$colorBlend = F3(
	function (fn, clB, clS) {
		...
		var calc = A4(_user$project$Color_Blending$calcChanel, fn, rgba1.alpha, rgba2.alpha, ar);
		return A4(
...
var _user$project$Color_Blending$colorDodge = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _user$project$Color_Blending$colorDodge$, clB, clS);
	});
var _user$project$Color_Blending$colorBurn = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _user$project$Color_Blending$colorBurn$, clB, clS);
	});
var _user$project$Color_Blending$softlight = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _user$project$Color_Blending$softlight$, clB, clS);
	});
var _user$project$Color_Blending$exclusion = F2(
	function (clB, clS) {
		return A3(
			_user$project$Color_Blending$colorBlend,
			F2(
				function (cB, cS) {
...
var _user$project$Color_Blending$difference = F2(
	function (clB, clS) {
		return A3(
			_user$project$Color_Blending$colorBlend,
			F2(
...
var _user$project$Color_Blending$lighten = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _elm_lang$core$Basics$max, clB, clS);
	});
var _user$project$Color_Blending$darken = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _elm_lang$core$Basics$min, clB, clS);
	});
var _user$project$Color_Blending$overlay = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _user$project$Color_Blending$overlay$, clB, clS);
	});
var _user$project$Color_Blending$hardlight = F2(
	function (clB, clS) {
		return A2(_user$project$Color_Blending$overlay, clS, clB);
	});
var _user$project$Color_Blending$screen = F2(
	function (clB, clS) {
		return A3(_user$project$Color_Blending$colorBlend, _user$project$Color_Blending$screen$, clB, clS);
	});
var _user$project$Color_Blending$multiply = F2(
	function (clB, clS) {
		return A3(
			_user$project$Color_Blending$colorBlend,
			F2(
...
var _user$project$Color_Convert$xyzToColor = function (_p0) {
	var _p1 = _p0;
	var c = function (ch) {
...
var _user$project$Color_Convert$labToXyz = function (_p2) {
	var _p3 = _p2;
	var y = (_p3.l + 16) / 116;
	var c = function (ch) {
		var ch$ = (ch * ch) * ch;
...
var _user$project$Color_Convert$labToColor = function (lab) {
	return _user$project$Color_Convert$xyzToColor(
		_user$project$Color_Convert$labToXyz(lab));
};
var _user$project$Color_Convert$xyzToLab = function (_p4) {
	var _p5 = _p4;
	var c = function (ch) {
...
var _user$project$Color_Convert$colorToXyz = function (cl) {
...
var _user$project$Color_Convert$colorToLab = function (cl) {
	return _user$project$Color_Convert$xyzToLab(
		_user$project$Color_Convert$colorToXyz(cl));
};
var _user$project$Color_Convert$toRadix = function (n) {
	...
	return (_elm_lang$core$Native_Utils.cmp(n, 16) < 0) ? getChr(n) : A2(
		_elm_lang$core$Basics_ops['++'],
		_user$project$Color_Convert$toRadix((n / 16) | 0),
		getChr(
			A2(_elm_lang$core$Basics_ops['%'], n, 16)));
};
var _user$project$Color_Convert$toHex = function (n) {
	var hex = _user$project$Color_Convert$toRadix(n);
	return _elm_lang$core$Native_Utils.eq(
		_elm_lang$core$String$length(hex),
		1) ? A2(_elm_lang$core$Basics_ops['++'], '0', hex) : hex;
};
var _user$project$Color_Convert$colorToHex = function (cl) {
	...
	return A2(
		...
		A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Color_Convert$toHex(red),
			A2(
				_elm_lang$core$Basics_ops['++'],
				_user$project$Color_Convert$toHex(green),
				_user$project$Color_Convert$toHex(blue))));
};
var _user$project$Color_Convert$hexToColor = function (c) {
...
var _user$project$Color_Convert$cssColorString = F2(
...
var _user$project$Color_Convert$toPercentString = function (h) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
...
var _user$project$Color_Convert$hueToString = function (h) {
	return _elm_lang$core$Basics$toString(
		_elm_lang$core$Basics$round((h * 180) / _elm_lang$core$Basics$pi));
};
var _user$project$Color_Convert$colorToCssHsla = function (cl) {
	...
	return A2(
		_user$project$Color_Convert$cssColorString,
		'hsla',
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$Color_Convert$hueToString(hue),
				_user$project$Color_Convert$toPercentString(saturation),
				_user$project$Color_Convert$toPercentString(lightness),
				_elm_lang$core$Basics$toString(alpha)
			]));
};
var _user$project$Color_Convert$colorToCssHsl = function (cl) {
...
var _user$project$Color_Convert$colorToCssRgba = function (cl) {
...
var _user$project$Color_Convert$colorToCssRgb = function (cl) {
...
var _user$project$Color_Convert$XYZ = F3(
	function (a, b, c) {
		return {x: a, y: b, z: c};
	});
var _user$project$Color_Convert$Lab = F3(
	function (a, b, c) {
		return {l: a, a: b, b: c};
	});

var _user$project$Color_Interpolate$linear = F3(
	function (t, i1, i2) {
		return i1 + ((i2 - i1) * t);
	});
var _user$project$Color_Interpolate$degree360 = _elm_lang$core$Basics$degrees(360);
var _user$project$Color_Interpolate$degree180 = _elm_lang$core$Basics$degrees(180);
var _user$project$Color_Interpolate$interpolate = F4(
	function (space, cl1, cl2, t) {
		var i = _user$project$Color_Interpolate$linear(t);
		var _p0 = space;
		switch (_p0.ctor) {
			case 'RGB':
				var cl2$ = _elm_lang$core$Color$toRgb(cl2);
				var cl1$ = _elm_lang$core$Color$toRgb(cl1);
				return A4(
					_elm_lang$core$Color$rgba,
					_elm_lang$core$Basics$round(
						A2(
							i,
							_elm_lang$core$Basics$toFloat(cl1$.red),
							_elm_lang$core$Basics$toFloat(cl2$.red))),
					_elm_lang$core$Basics$round(
						A2(
							i,
							_elm_lang$core$Basics$toFloat(cl1$.green),
							_elm_lang$core$Basics$toFloat(cl2$.green))),
					_elm_lang$core$Basics$round(
						A2(
							i,
							_elm_lang$core$Basics$toFloat(cl1$.blue),
							_elm_lang$core$Basics$toFloat(cl2$.blue))),
					A2(i, cl1$.alpha, cl2$.alpha));
			case 'HSL':
				var cl2$ = _elm_lang$core$Color$toHsl(cl2);
				var h2 = cl2$.hue;
				var cl1$ = _elm_lang$core$Color$toHsl(cl1);
				var h1 = cl1$.hue;
				var dH = ((_elm_lang$core$Native_Utils.cmp(h2, h1) > 0) && (_elm_lang$core$Native_Utils.cmp(h2 - h1, _user$project$Color_Interpolate$degree180) > 0)) ? ((h2 - h1) + _user$project$Color_Interpolate$degree360) : (((_elm_lang$core$Native_Utils.cmp(h2, h1) < 0) && (_elm_lang$core$Native_Utils.cmp(h1 - h2, _user$project$Color_Interpolate$degree180) > 0)) ? ((h2 + _user$project$Color_Interpolate$degree360) - h1) : (h2 - h1));
				return A4(
					_elm_lang$core$Color$hsla,
					h1 + (t * dH),
					...
					A2(i, cl1$.alpha, cl2$.alpha));
			default:
				var lab2 = _user$project$Color_Convert$colorToLab(cl2);
				var lab1 = _user$project$Color_Convert$colorToLab(cl1);
				return _user$project$Color_Convert$labToColor(
					{
...
var _user$project$Color_Interpolate$LAB = {ctor: 'LAB'};
var _user$project$Color_Interpolate$HSL = {ctor: 'HSL'};
var _user$project$Color_Interpolate$RGB = {ctor: 'RGB'};

var _user$project$Color_Gradient$getNextGradientStop = F2(
...
var _user$project$Color_Gradient$calculateColor = F4(
	function (space, _p2, _p1, t) {
		...
		var _p4 = _p1;
		var _p5 = _p4._1;
		return _elm_lang$core$Native_Utils.eq(t, 0) ? _p6 : (_elm_lang$core$Native_Utils.eq(t, 1) ? _p5 : A4(_user$project$Color_Interpolate$interpolate, space, _p6, _p5, (t - _p7) / (_p4._0 - _p7)));
	});
var _user$project$Color_Gradient$calculateGradient = F5(
	function (space, stop1, stop2, gradient, t) {
		if (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$Basics$fst(stop2),
			t) < 0) {
			var _p8 = A2(_user$project$Color_Gradient$getNextGradientStop, stop2, gradient);
			var stop2$ = _p8._0;
			var gradient$ = _p8._1;
			var stop1$ = stop2;
			return {
				...
				_1: stop2$,
				_2: gradient$,
				_3: A4(_user$project$Color_Gradient$calculateColor, space, stop1$, stop2$, t)
			};
		} else {
			return {
				ctor: '_Tuple4',
...
var _user$project$Color_Gradient$c = F3(
	function (space, t, _p9) {
		var _p10 = _p9;
		var _p11 = A5(_user$project$Color_Gradient$calculateGradient, space, _p10._0, _p10._1, _p10._2, t);
		var stop1$ = _p11._0;
		var stop2$ = _p11._1;
		...
		return {
			...
			_1: stop2$,
			_2: gradient$,
			_3: A2(_elm_lang$core$List_ops['::'], color, _p10._3)
		};
	});
var _user$project$Color_Gradient$gradientFromStops = F3(
	function (space, stops, size) {
		...
		if (_p17.ctor === 'Just') {
			...
			var _p18 = A2(_user$project$Color_Gradient$getNextGradientStop, _p21, currentStops);
			var s2 = _p18._0;
			var g = _p18._1;
			var l = size - 1;
			var stops = A2(
				_elm_lang$core$List$map,
				function (i) {
					return _elm_lang$core$Basics$toFloat(i) / l;
				},
				_elm_lang$core$Native_List.range(0, l));
			return _elm_lang$core$List$reverse(
				function (_p19) {
					var _p20 = _p19;
					return _p20._3;
					...
					A3(
						_elm_lang$core$List$foldl,
						_user$project$Color_Gradient$c(space),
						{
							ctor: '_Tuple4',
							_0: _p21,
							_1: s2,
...
var _user$project$Color_Gradient$gradient = F3(
	function (space, palette, size) {
		...
		var gr = A3(
			...
			_elm_lang$core$Native_List.range(0, l),
			palette);
		return A3(_user$project$Color_Gradient$gradientFromStops, space, gr, size);
	});

var _user$project$Color_Manipulate$rotateHue = F2(
	function (angle, cl) {
...
var _user$project$Color_Manipulate$limit = A2(_elm_lang$core$Basics$clamp, 0, 1);
var _user$project$Color_Manipulate$darken = F2(
	function (offset, cl) {
		...
		return A4(
			...
			hue,
			saturation,
			_user$project$Color_Manipulate$limit(lightness - offset),
			alpha);
	});
var _user$project$Color_Manipulate$lighten = F2(
	function (offset, cl) {
		return A2(_user$project$Color_Manipulate$darken, 0 - offset, cl);
	});
var _user$project$Color_Manipulate$saturate = F2(
	function (offset, cl) {
		...
		return A4(
			_elm_lang$core$Color$hsla,
			hue,
			_user$project$Color_Manipulate$limit(saturation + offset),
			lightness,
			alpha);
	});
var _user$project$Color_Manipulate$desaturate = F2(
	function (offset, cl) {
		return A2(_user$project$Color_Manipulate$saturate, 0 - offset, cl);
	});
var _user$project$Color_Manipulate$grayscale = function (cl) {
	return A2(_user$project$Color_Manipulate$saturate, -1, cl);
};
var _user$project$Color_Manipulate$fadeIn = F2(
	function (offset, cl) {
		...
		return A4(
			...
			saturation,
			lightness,
			_user$project$Color_Manipulate$limit(alpha + offset));
	});
var _user$project$Color_Manipulate$fadeOut = F2(
	function (offset, cl) {
		return A2(_user$project$Color_Manipulate$fadeIn, 0 - offset, cl);
	});

var _user$project$Tests$p2Result = _elm_lang$core$Native_List.fromArray(
	[
		A3(_elm_lang$core$Color$rgb, 200, 0, 200),
		A3(_elm_lang$core$Color$rgb, 0, 100, 100),
		A3(_elm_lang$core$Color$rgb, 50, 125, 120),
		A3(_elm_lang$core$Color$rgb, 100, 150, 140),
		A3(_elm_lang$core$Color$rgb, 150, 175, 160)
	]);
var _user$project$Tests$p2 = _elm_lang$core$Native_List.fromArray(
	[
		{
		ctor: '_Tuple2',
		_0: 0,
		_1: A3(_elm_lang$core$Color$rgb, 200, 0, 200)
	},
		{
		ctor: '_Tuple2',
		_0: 0.25,
		_1: A3(_elm_lang$core$Color$rgb, 0, 100, 100)
	},
		{
		ctor: '_Tuple2',
		_0: 1,
		_1: A3(_elm_lang$core$Color$rgb, 150, 175, 160)
	}
	]);
var _user$project$Tests$p1Result = _elm_lang$core$Native_List.fromArray(
	[
		A3(_elm_lang$core$Color$rgb, 200, 0, 200),
		A3(_elm_lang$core$Color$rgb, 100, 50, 150),
		A3(_elm_lang$core$Color$rgb, 0, 100, 100),
		A3(_elm_lang$core$Color$rgb, 50, 50, 50),
		A3(_elm_lang$core$Color$rgb, 100, 0, 0)
	]);
var _user$project$Tests$p1 = _elm_lang$core$Native_List.fromArray(
	[
		A3(_elm_lang$core$Color$rgb, 200, 0, 200),
		A3(_elm_lang$core$Color$rgb, 0, 100, 100),
		A3(_elm_lang$core$Color$rgb, 100, 0, 0)
	]);
var _user$project$Tests$gradient = A2(
	...
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				...
				A3(_user$project$Color_Gradient$gradient, _user$project$Color_Interpolate$RGB, _user$project$Tests$p1, 5),
				_user$project$Tests$p1Result)),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Gradient from stops',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A3(_user$project$Color_Gradient$gradientFromStops, _user$project$Color_Interpolate$RGB, _user$project$Tests$p2, 5),
				_user$project$Tests$p2Result))
		]));
var _user$project$Tests$interpolation = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Interpolate',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A4(
					_user$project$Color_Interpolate$interpolate,
					_user$project$Color_Interpolate$RGB,
					A4(_elm_lang$core$Color$rgba, 0, 0, 0, 0),
					A4(_elm_lang$core$Color$rgba, 255, 255, 255, 1),
					0.5),
				A4(_elm_lang$core$Color$rgba, 128, 128, 128, 0.5)))
		]));
var _user$project$Tests$c2 = A3(_elm_lang$core$Color$rgb, 0, 255, 0);
var _user$project$Tests$c1 = A3(_elm_lang$core$Color$rgb, 255, 102, 0);
var _user$project$Tests$blending = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Blending',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$multiply, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 0, 102, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Screen',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$screen, _user$project$Tests$c1, _user$project$Tests$c2),
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$overlay, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 255, 204, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Softlight',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$softlight, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 255, 161, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Hardlight',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$hardlight, _user$project$Tests$c1, _user$project$Tests$c2),
				_user$project$Tests$c2)),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Difference',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$difference, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 255, 153, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Exclusion',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$exclusion, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 255, 153, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Darken',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$darken, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 0, 102, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Lighten',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(_user$project$Color_Blending$lighten, _user$project$Tests$c1, _user$project$Tests$c2),
				A3(_elm_lang$core$Color$rgb, 255, 255, 0)))
		]));
var _user$project$Tests$manipulate = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Manipulate',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$darken,
					0.5,
					A3(_elm_lang$core$Color$hsl, 1, 1, 1)),
				A3(_elm_lang$core$Color$hsl, 1, 1, 0.5))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Darken should be limit to 0',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$darken,
					10,
					A3(_elm_lang$core$Color$hsl, 1, 1, 1)),
				A3(_elm_lang$core$Color$hsl, 1, 1, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Lighten',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$lighten,
					0.5,
					A3(_elm_lang$core$Color$hsl, 1, 1, 0.2)),
				A3(_elm_lang$core$Color$hsl, 1, 1, 0.7))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Lighten should be limit to 1',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$lighten,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$saturate,
					0.5,
					A3(_elm_lang$core$Color$hsl, 1, 0, 1)),
				A3(_elm_lang$core$Color$hsl, 1, 0.5, 1))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Saturate should be limit to 1',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$saturate,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$desaturate,
					0.5,
					A3(_elm_lang$core$Color$hsl, 1, 1, 1)),
				A3(_elm_lang$core$Color$hsl, 1, 0.5, 1))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Desaturate should be limit to 0',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$desaturate,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Manipulate$grayscale(
					A3(_elm_lang$core$Color$hsl, 1, 1, 1)),
				A3(_elm_lang$core$Color$hsl, 1, 0, 1))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$fadeIn,
					0.2,
					A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.5)),
				A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.7))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Fade in should be limit to 1',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$fadeIn,
					10,
					A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.5)),
				A4(_elm_lang$core$Color$hsla, 1, 1, 1, 1))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Fade out',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$fadeOut,
					0.2,
					A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.5)),
				A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.3))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Fade out should be limit to 0',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$fadeOut,
					10,
					A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0.5)),
				A4(_elm_lang$core$Color$hsla, 1, 1, 1, 0))),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Rotate hue',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$rotateHue,
					90,
					A4(_elm_lang$core$Color$hsla, 0, 1, 1, 0)),
				A4(
					_elm_lang$core$Color$hsla,
			...
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Rotate hue with negative value',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				A2(
					_user$project$Color_Manipulate$rotateHue,
...
var _user$project$Tests$convert = A2(
	_elm_community$elm_test$ElmTest$suite,
	'Convert',
	_elm_lang$core$Native_List.fromArray(
		[
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$colorToCssRgb(
					A3(_elm_lang$core$Color$rgb, 255, 125, 0)),
				'rgb(255, 125, 0)')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$colorToCssRgba(
					A4(_elm_lang$core$Color$rgba, 255, 125, 0, 0.3)),
				'rgba(255, 125, 0, 0.3)')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Color to hsl String',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$colorToCssHsl(
					A3(_elm_lang$core$Color$hsl, 0.4, 0.2, 0)),
				'hsl(23, 20%, 0%)')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Color to hsla String',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$colorToCssHsla(
					A4(_elm_lang$core$Color$hsla, 0.4, 0.2, 0, 1)),
				'hsla(23, 20%, 0%, 1)')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Color to hex String',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$colorToHex(
					A3(_elm_lang$core$Color$rgb, 255, 0, 255)),
				'#ff00ff')),
			A2(
			_elm_community$elm_test$ElmTest$test,
			'Hex string to hex color',
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$hexToColor('#ff00ff'),
			...
			A2(
				_elm_community$elm_test$ElmTest$assertEqual,
				_user$project$Color_Convert$hexToColor('1234'),
				_elm_lang$core$Maybe$Nothing))
		]));
var _user$project$Tests$all = A2(
	...
	'All tests',
	_elm_lang$core$Native_List.fromArray(
		[_user$project$Tests$convert, _user$project$Tests$manipulate, _user$project$Tests$blending, _user$project$Tests$gradient, _user$project$Tests$interpolation]));
