...
manipulate =
    suite "Manipulate"
        ...
        , test "Scale HSL saturation with positive value" (assertEqual (hsl (degrees 120) 0.51 0.9) (scaleHsl ( 0.3, 0, 0 ) (hsl (degrees 120) 0.3 0.9)))
        , test "Scale HSL saturation with negative value" (assertEqual (hsl (degrees 120) 0.21 0.9) (scaleHsl ( -0.3, 0, 0 ) (hsl (degrees 120) 0.3 0.9)))
        , test "Scale HSL lightness with positive value" (assertEqual (hsl (degrees 120) 0.3 0.915) (scaleHsl ( 0, 0.15, 0 ) (hsl (degrees 120) 0.3 0.9)))
        , test "Scale HSL lightness with negative value" (assertEqual (hsl (degrees 120) 0.3 0.765) (scaleHsl ( 0, -0.15, 0 ) (hsl (degrees 120) 0.3 0.9)))
        , test "Scale HSL alpha with positive value" (assertEqual (hsla (degrees 120) 0.3 0.9 0.14) (scaleHsl ( 0, 0, 0.14 ) (hsla (degrees 120) 0.3 0.9 0)))
        , test "Scale HSL alpha with negative value" (assertEqual (hsla (degrees 120) 0.3 0.9 0.86) (scaleHsl ( 0, 0, -0.14 ) (hsl (degrees 120) 0.3 0.9)))
